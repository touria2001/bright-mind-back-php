...
<body>
   <form method="post" id="sign-in-form" action="">
    <input type="email" name="email" value="<?php if(isset($_COOKIE["emailBrightAdmin"])) echo $_COOKIE["emailBrightAdmin"];?>">
    <p id="emailError"></p>
    <input type="password" name="pw" value="<?php if(isset($_COOKIE["passwordBrightAdmin"])){ echo $_COOKIE['passwordBrightAdmin'];}?>">
    <p id="pwError"></p>
